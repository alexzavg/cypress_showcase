...
parser.add_argument('-a', '--app', { help: 'The app that Cypress ran against (ie, SauceLabs)', required: true })
parser.add_argument('--build', { help: 'The Jenkins build number (optional)' })
